...
define(['com.izaakschroeder.trait', './lazy'], function(Trait, Lazy) {
	...
	function Node(color, height, value, compare, left, right) {
		...
		if (typeof compare !== "function")
			throw new TypeError('Must give valid compare function; got: '+compare);
	 ...
	 *
	 */
	Node.prototype.createNode = function(color, height, value, compare, left, right) {
		return new Node(color, height, value, compare, left, right);
	}
	 ...
	 *
	 */
	Node.prototype.createLeaf = function(compare) {
	...
	Node.prototype.empty = function(compare) {
		return this.createLeaf(compare || this.compare);
	}
	...
	Node.empty = function(compare) {
		return new Leaf(compare || Node.defaultCompare);
	}
	 ...
	 *
	 */
	Node.fromEntry = function(item, compare) {
		return Node.empty(compare).insert(item);
	}
	 ...
	 *
	 */
	Node.fromCollection = function(array, compare) {
		return array.reduce(function(prev, cur) { return prev.insert(cur); }, Node.empty(compare))
	}

	Node.prototype._getNext = function() {
		var node = this;
		return function() {
	...
	Node.prototype.iterator = function() {
		return Lazy.create(this).iterator();
	}
	*/
	...
	Node.prototype.first = function(val, _return) {
		var self = this;
		return self.left.first(self.value, function() {
			return self.right.first(val, _return)
		})
	}
	 ...
	 *
	 */
	Node.prototype.find = function(item, noThrow) {
		var result = this._find(item);
	...
	Node.prototype.concat = function() {
		...
		for(var i = 0; i < arguments.length; ++i) {
			if (arguments[i] instanceof Node)
				...
				cur = cur.union(Node.fromCollection(arguments[i], this.compare));
			else
	...
	Node.prototype.equals = function(other) {
		if (other instanceof Node === false)
			other = this.empty().insertAll(other);
		return this._equals(other);
	}

	Node.prototype._equals = function(other) {
		return this.compare(this.value, other.value) === 0 && this.left._equals(other.left) && this.right._equals(other.right);
	}
	...
	Node.prototype.redden = function() {
		return this.color === Node.Red ? this : this.createNode(Node.Red, this.height, this.value, this.compare, this.left, this.right);
	}

	Node.prototype.blacken = function() {
		return this.color === Node.Black ? this : this.createNode(Node.Black, this.height, this.value, this.compare, this.left, this.right);
	}
	...
	Node.prototype._insert = function(value) {
		...
		return this.createNode(this.color, this.height, value, this.compare, this.left, this.right);
	}

	Node.prototype.setLeft = function(node) {
		if (this.left === node)
			return this;
		return this.createNode(this.color, this.height, this.value, this.compare, node, this.right).balanceLeft();
	}

	Node.prototype.setRight = function(node) {
		if (this.right === node)
			return this;
		return this.createNode(this.color, this.height, this.value, this.compare, this.left, node).balanceRight();	
	}

	Node.prototype.balanceLeft = function() {
		if (this.color === Node.Black && this.left.color === Node.Red && this.left.left.color === Node.Red)
			return this.createNode(Node.Red, this.height+1, this.left.value, this.compare, this.left.left.blacken(), this.createNode(Node.Black, this.height, this.value, this.compare, this.left.right, this.right));
		return this;
	}

	Node.prototype.balanceRight = function() {
		if (this.color === Node.Black && this.left.color === Node.Red && this.right.color === Node.Red)
			return this.createNode(Node.Red, this.height+1, this.value, this.compare, this.left.blacken(), this.right.blacken());
		if (this.right.color === Node.Red)
			return this.createNode(this.color, this.height, this.right.value, this.compare, this.createNode(Node.Red, this.right.height, this.value, this.compare, this.left, this.right.left), this.right.right);
		return this;
	}
	...
	Node.join = function(left, right, pivot) {
		...
		//FIXME: use left or right?
		return left.createNode(Node.Black, left.height+1, pivot, left.compare, left, right);
	}

	Node.joinLeft = function(left, right, pivot, height) {
		if (height === right.height)
			return left.createNode(Node.Red, right.height+1, pivot, left.compare, left, right);
	...
	Node.joinRight = function(left, right, pivot, height) {
		if (height === left.height)
			return left.createNode(Node.Red, left.height+1, pivot, left.compare, left, right);
	...
	Leaf.prototype._equals = function(other) {
	...
	Leaf.prototype._insert = function(value) {
		return this.createNode(Node.Red, 1, value, this.compare, this, this)
	}
	...
	Leaf.prototype.first = function(val, _return) {
		return { value: val, next: _return };
	}

	Node.defaultCompare = function(a, b) { 
		...
		if (b && typeof b.compare === 'function')
			return b.compare(a);
		throw new TypeError('Unable to compare '+a.construc+','+b+'.'); 
	}
